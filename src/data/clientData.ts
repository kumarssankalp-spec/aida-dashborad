...
export const clientProjects: Record<string, ProjectData> = {
  'client-a': {
    clientId: 'client-a',
    title: 'E-Commerce Platform for Dogs',
    subtitle: 'Modern, responsive online store with advanced features',
    requirements: [
      'Mobile-first responsive design',
      'Advanced product filtering and search',
      'Integrated payment gateway (Stripe, PayPal, cards)',
    ...
    designs: [
      {
        ...
        description: 'Exclusive premium design with advanced features',
      ...
      },
      {
        ...
        description: 'Pet pals is a simple website ',
      ...
      },
      {
        ...
        description: 'Bold, colorful design with engaging animations',
      ...
      },
      {
        ...
        description: 'Traditional business-focused layout',
    ...
    proposalDetails: {
      ...
      discount: 10,
      deliverables: ['Responsive Website', 'E-commerce Store', 'Payment Gateway', 'Admin Panel']
    }
  },
  'client-b': {
    clientId: 'client-b',
    ...
    proposalDetails: {
      ...
      deliverables: ['Custom Dashboard', 'Analytics Platform', 'User Management System', 'API Integrations']
    }
  },
  'client-c': {
    clientId: 'client-c',
    ...
    proposalDetails: {
      ...
      discount: 15,
      deliverables: ['iOS Mobile App', 'Android Mobile App', 'Web Admin Portal', 'Push Notification System']
    }
  }
};
